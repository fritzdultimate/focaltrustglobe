...
<style type="text/css">
    a { text-decoration: none; outline: none; }<div class=""><div class="aHl"></div><div id=":2ov" tabindex="-1"></div><div id=":2ok" class="ii gt" jslog="20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0."><div id=":2oj" class="a3s aiL msg-8062522496108755033"><div class="adM">
                              ...
                              <tbody>
                                <tr>
                                  <td align="left" style="font-size:0px;padding:5px 5px 10px 5px;word-break:break-word">
                                    <div style="font-family:BinancePlex,Arial,PingFangSC-Regular,'Microsoft YaHei',sans-serif;font-size:20px;font-weight:900;line-height:25px;text-align:left;color:#000000">Reinvestment
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="left" style="background:#ffffff;font-size:0px;padding:5px 5px 5px 5px;word-break:break-word">
                                    <div style="font-family:BinancePlex,Arial,PingFangSC-Regular,'Microsoft YaHei',sans-serif;font-size:14px;line-height:20px;text-align:left;color:#000000">
                                      ...
                                      your reinvestment of {{ $details['amount'] }} USD has been received. Log into your wallet to check your balance.&nbsp;
                          ...
                          <tbody>
                            <tr>
                              <td style="padding:0px 5px;font-size:0;height:20px;vertical-align:middle;width:20px">
                                <a href="https://t.me/@Agentfortressminers" target="_blank">
                      ...
                      <td style="padding:4px;vertical-align:middle">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-radius:3px;width:20px">
                          <tbody>
                            <tr>
                              <td style="padding:0px 5px;font-size:0;height:20px;vertical-align:middle;width:20px">
                                <a href="https://www.youtube.com/@fortressminerscompany6009" target="_blank">
                      ...
                      <td style="padding:4px;vertical-align:middle">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-radius:3px;width:20px">
                          <tbody>
                            <tr>
                              <td style="padding:0px 5px;font-size:0;height:20px;vertical-align:middle;width:20px">
                                <a href="https://instagram.com/fortress_miners_company?igshid=YmMyMTA2M2Y=" target="_blank">
                ...
                <td class="o_bg-dark o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg Dark" style="background-color:#050625;padding-left: 24px;padding-right: 24px;padding-top: 44px;padding-bottom: 44px;">
                  ...
                  <div class="o_col-6s o_center o_sans o_text-md o_text-white" data-color="White" data-size="Text MD" data-min="15" data-max="23" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;max-width: 584px;color: #ffffff;text-align: center;">
                    ...
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 14px;">
                        Your reinvestment of ${{ $details['amount'] }} was created!
                    </p>
