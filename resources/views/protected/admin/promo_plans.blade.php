    ...
    <main class="app-content">
        ...
        <div class="page-title m-b-20">
            <div class="row justify-content-between">
                <div class="col-md-2">
                <h1 class="page-title">
                    <span class="fa fa-list-ul"></span> Promo plans
                </h1>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-vcenter card-table">
                            ...
                            <tbody>
                                @foreach($promo_plans as $id => $plan)
                                <tr class="tr_1b667862cb93ecba7c392f57bb29763b">
                                    ...
                                    <td>
                                        ...
                                        <div class="sub text-muted">Promo plan</div>
                                    </td>
                                    ...
                                    <td class="text-center w-15p">{{ get_day_format($plan->exp_date) }}</td>
    ...
    <div id="main-modal-content">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="add-promo-plan-form">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btn-min-width mr-1 mb-1 add-promo-plan">Save</button>
    ...
    <div id="main-modal-content">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="edit-promo-plan-form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label>Expired?</label>
                                    <select id="date" name="expired"  class="form-control">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btn-min-width mr-1 mb-1 edit-promo-plan">Edit</button>
                        <button type="button" class="btn btn-dark dismiss-modal" data-dismiss="modal">Close</button>
                    </div>
                </form>    
            </div>
...
let headers = {
    ...
    [...document.querySelectorAll('.edit-plan')].forEach(el => {
        el.addEventListener('click', (e) => {
            ...
            document.querySelector('#date').value = e.currentTarget.dataset.date;
    ...
    document.querySelector('.add-promo-plan').addEventListener('click', (el) => {
        el.preventDefault();
        let form = document.querySelector('.add-promo-plan-form');
        console.log(form)
        fetch(urlPrefix + `admin/plans/promo/create`, {
            method : 'post',
            headers,
            body : JSON.stringify({
                ...jsonFormData(form)
    ...
    document.querySelector('.edit-promo-plan').addEventListener('click', (el) => {
        el.preventDefault();
        let form = document.querySelector('.edit-promo-plan-form');
        console.log(form)
        fetch(urlPrefix + `admin/plans/promo/update`, {
            method : 'post',
            headers,
            body : JSON.stringify({
                ...jsonFormData(form)
