...
<html lang="en">
    <head>
        <title>Fortressminers | Login</title>
        ...
        <meta name="description" content="Fortressminers | Login and start your financial freedom journey!">
        <meta name="keywords"
        ...
        <div class="section mb-5 p-2">
            ...
            <form class="login-form">
                    ...
                    <div class="card-body pb-1">
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-control" id="email1" name="login" placeholder="Your e-mail or username">
                                <i class="clear-input">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper" id="password-wrapper">
                                ...
                                <i class="eye-input" id="pass-eye">
                                    <ion-icon id="toggler" name="eye"></ion-icon>
                                </i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-button-group  transparent mb-5">
                    <button type="submit" class="form-button btn btn-primary btn-block btn-lg">Log in</button>
    ...
    <script src="{{ asset('dash/js/login.js?ref=11') }}"></script>
    ...
    <script>
        document.querySelector('#pass-eye').addEventListener('click', (event) => {
            isoff = document.querySelector('#toggler').name == 'eye' ? false : true;

            if(isoff) {
                document.querySelector("#password1").type = 'password';
                document.querySelector('#toggler').name = 'eye'
            } else {
                document.querySelector("#password1").type = 'text';
                document.querySelector('#toggler').name = 'eye-off'
            }
        })
    </script>
