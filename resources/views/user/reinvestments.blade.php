                            ...
                            <table class="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                ...
                                <tbody>
                                    ...
                                    <tr class="background_white">
                                        ...
                                        <td>
                                            <div class="pretty p-svg p-curve">Reinvestment</div>
                                        </td>
                                        <td>
                                            <div class="pretty p-svg p-curve">{{ $reinvestment->user_wallet->admin_wallet->currency }}</div>
                                        </td>
                                        <td class="flag">
                                            <div class="pretty p-svg p-curve">{{ get_day_format($reinvestment['created_at']) }}</div>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
