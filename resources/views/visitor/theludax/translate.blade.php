<style type="text/css">
    .ekemm3kmem {
        ...
        /* border : none; */
        border: 2px solid #bdbddb69 !important;
    ...
    select.ekemm3kmem option {
        background: white;
        color: #000;
    }
    .ekemm3kmem:focus-within, .ekemm3kmem:focus {
    background-color: initial !important;
    }
.ekemm3kmem:focus-within, .ekemm3kmem:focus{
    background-color : #102432 !important;
}
.dropdown.bootstrap-select.ekemm3kmem{
    width : inherit !important;
}
</style>
...
<select class="ekemm3kmem  default-select" onchange="doGTranslate(this);" style="width : 110px !important;" translate="no">
